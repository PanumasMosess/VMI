	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1><i class="fa fa-caret-right"></i>&nbsp;Replenishment Order<small>VMI Order (Auto alert to refill)</small></h1>
				<ol class="breadcrumb">
			...
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-info">
							...
							<div style="padding-left: 8px;">
								...
								<font style="color: #00F;">SQL >_ SELECT * ROWS</font> | <font style="color: #F00;">Refill Type: VMI Order Can't delete.</font>
							</div>
					...
					$objResult_delete_vmi_duplicate = sqlsrv_fetch_array($objQuery_delete_vmi_duplicate, SQLSRV_FETCH_ASSOC);
