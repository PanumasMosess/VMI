	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1><i class="fa fa-caret-right"></i>&nbsp;Replenishment Order B2C</h1>
				<ol class="breadcrumb">
					<li><a href="<?= $CFG->wwwroot; ?>/home"><i class="fa fa-home"></i>Home</a></li>
					<li class="active">Replenishment Order B2C</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box box-info">
							...
							<div class="box-header">
								<button type="button" class="btn btn-primary btn-sm" onclick="OpenFrmUploadOrder();"><i class="fa fa-cloud-upload"></i> Upload Order</button>&nbsp;|&nbsp;
							...
							<div class="box-body table-responsive padding">
								<table id="tbl_replenishment_order" class="table table-bordered table-hover table-striped nowrap">
									...
									<tbody>
										...
										on tbl_replenishment.repn_order_ref = tbl_b2c_sale.b2c_sale_order_id
										...
										?>
											<tr style="font-size: 13px;">
												...
												<td><?= $b2c_sale_including_vat; "บาท." ?></td>
...
<div class="modal fade" id="modal-upload-order" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form name="frmUploadorder" action="<?= $CFG->src_replenishment; ?>/upload_order_b2c.php" method="post" enctype="multipart/form-data" target="iframe_target_uploadorder" onSubmit="return ChkSubmit_frmUploadorder();">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<a href="<?= $CFG->src_template_master_file; ?>/template_upload_order_mst_b2b.xlsx" target="_blank" data-placement="top" data-toggle="tooltip" data-original-title="Excel file"><i class="fa fa-cloud-download"></i>&nbsp;Template order master <i class="fa fa-file-excel-o"></i></a><br>
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<select class="form-control" name="txt_sel_cus" id="txt_sel_cus" style="width: 100%;">
									...
									<?
									$strSQL = " SELECT bom_cus_name FROM tbl_bom_mst where bom_status = 'Active' and bom_pj_name = 'B2C' group by bom_cus_name order by bom_cus_name asc ";
