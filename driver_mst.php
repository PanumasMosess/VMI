  ...
  ?>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1><i class="fa fa-caret-right"></i>&nbsp;Driver Master Data</h1>
				<ol class="breadcrumb">
					<li><a href="<?= $CFG->wwwroot; ?>/home"><i class="fa fa-home"></i>Home</a></li>
					<li class="active">Driver Master Data</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box box-success">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-car"></i>&nbsp;Driver List</h3>
							</div>
							<!-- /.box-header -->

							<div class="box-header">
								<div class="row">
									&nbsp;&nbsp;<button type="button" class="btn btn-success btn-md" onclick="addDriverModel();"><i class="fa fa-plus fa-lg"></i>&nbsp;Create Driver</button>&nbsp;|&nbsp;<button type="button" class="btn btn-info btn-md" onclick="reload_table();"><i class="fa fa-refresh fa-lg"></i>&nbsp;Refresh</button>
								</div>
							</div>
...
?>
	<script language="javascript">
		...
		function func_load_driver() {
			//Load data
			setTimeout(function() {
				$("#spn_load_data_main").load("<?= $CFG->src_driver; ?>/load_driver_mst.php");
			}, 500);
		...
		function openUpdateDriver(driver_id, driver_code, driver_name_th, driver_name_en, driver_company,
			driver_section, driver_truck_head_no, driver_truck_head_no, driver_truck_tail_no, driver_truck_type
		) {

			$('#txt_dri_name_th').val(driver_name_th);
			$('#txt_dri_name_en').val(driver_name_en);
			$('#txt_head_vehicle').val(driver_truck_head_no);
			$('#txt_tail_vehicle').val(driver_truck_tail_no);
			$('#txt_dri_code').val(driver_id);

			//dialog open
			$('#modal-update-driver').modal({});
		}

		//Confirm Update Driver
		function confirmUpdateDrive() {
		...
		function inActiveDriver(dri_id) {
			swal({
					html: true,
		...
		function addDriverModel() {
			//dialog open
			$('#modal-create-driver').modal({});
		}
		...
		function createDriver() {
			...
			var txt_dri_user_en_add = $('#txt_dri_user_en_add').val();
		...
		<div class="modal-content">
			...
			<form name="frmUploadorder">
				...
				<div class="modal-footer">
					<div align="right">
						<button type="button" class="btn btn-primary btn-sm" onclick="confirmUpdateDrive();">Update Driver</button>
...
<!--------------------dlg create driver-------------------->
<div class="modal fade" id="modal-create-driver" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<form name="frmUploadorder">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_dri_user_en_add">Driver User Name</label>
								<input type="text" class="form-control" name="txt_dri_user_en_add" id="txt_dri_user_en_add" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_dri_name_th_add">Driver Name (TH)</label>
								<input type="text" class="form-control" name="txt_dri_name_th_add" id="txt_dri_name_th_add" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_dri_name_en_add">Driver Name (EN)</label>
								<input type="text" class="form-control" name="txt_dri_name_en_add" id="txt_dri_name_en_add" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_dri_company_add">Driver Driver Company</label>
								<input type="text" class="form-control" name="txt_dri_company_add" id="txt_dri_company_add" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_sel_dri_shift_add">Select Shift</label>
								<select class="form-control" name="txt_sel_dri_shift_add" id="txt_sel_dri_shift_add" style="width: 100%;">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="txt_dri_tail_add">Tail Vehicle Registration Number</label>
								<input type="text" class="form-control" name="txt_dri_tail_add" id="txt_dri_tail_add" />
							</div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<div align="right">
						<button type="button" class="btn btn-success btn-sm" onclick="createDriver();"><i class="fa fa-plus"></i> Create Driver</button>
						<button type="button" class="btn btn-default btn-sm" onclick="closeModal();">Close</button>
					</div>
				</div>
			</form>
