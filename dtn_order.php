...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-caret-right"></i>&nbsp;Confirm DTN Order<small>Delivery Transfer Note</small></h1>
      <ol class="breadcrumb">
        <li><a href="<?=$CFG->wwwroot;?>/home"><i class="fa fa-home"></i>Home</a></li><li class="active">Confirm DTN Order</li>
      </ol>
    </section>
		...
		<div class="box box-warning">
			...
			<div class="box-body">
			  ...
			  <!-- /.row -->
				...
				<div class="box-header with-border">
				  <h3 class="box-title"><i class="fa fa-files-o"></i> Picking Sheet List (Completed Picking QC)</h3> | <font style="color: #F00;">* Please select by Project or Customer</font>
				</div>
				<!-- /.box-header -->
				
				<div class="box-header">
					<button type="button" class="btn btn-success btn-sm" onclick="confirmDTN();"><i class="fa fa-check-square-o"></i> Confirm DTN</button>&nbsp;/&nbsp;<button type="button" class="btn btn-info btn-sm" onclick="_load_waiting_conf_dtn();"><i class="fa fa-refresh fa-lg"></i> Refresh</button>
				</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-header with-border">
					  <h3 class="box-title"><img src="<?=$CFG->iconsdir;?>/truck.png" height="18px"> Delivery Transfer Note List</h3>
					</div>
					<!-- /.box-header -->
...
function _load_dtn_sheet_details()
{
	...
	setTimeout(function(){
		...
		$("#spn_load_dtn_sheet_details").load("<?=$CFG->src_dtn_order;?>/load_dtn_sheet_details.php");
	},300);
}
...
function _load_waiting_conf_dtn()
{
	...
	setTimeout(function(){
		...
		$("#spn_load_waiting_conf_dtn").load("<?=$CFG->src_dtn_order;?>/load_waiting_conf_dtn.php");
	},300);
}
