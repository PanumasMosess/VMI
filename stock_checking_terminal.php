  ...
  ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><i class="fa fa-caret-right"></i>&nbsp;Stock Checking Terminal<small>Storage Location</small></h1>
                <ol class="breadcrumb">
                    <li><a href="<?= $CFG->wwwroot; ?>/home"><i class="fa fa-home"></i>Home</a></li>
                    <li class="active">Stock Checking Terminal</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="sel_fj_name" name="sel_fj_name" class="form-control select2" style="width: 100%;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt_stock_wms_qty" name="txt_stock_wms_qty" class="form-control" maxlength="5" placeholder="Stock Terminal Qty." disabled>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    <!-- /.col -->
                            ...
                            <!-- <div class="box-footer">
                                <button type="button" class="btn btn-primary btn-sm" onclick="confirm_checkStock()"><i class="fa fa-check"></i> Confirm Check Stock ID</button>
                            </div> -->
                        </div>
                        <!-- /.box -->
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-warning">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><i class="fa fa-list"></i> Stock Checking Terminal List </h3>
                                    </div>
                                    <!-- /.box-header -->
    ...
    <script>
        ...
        function _onScan_checking_code(even) {
            ...
            if (even.keyCode == 13) {
                if (document.getElementById('txt_tag_id').value == "") {
                ...
                } else if (document.getElementById('sel_fj_name').value == "") {
                    swal({
                        html: true,
                        title: "<span style='font-size: 30px; font-weight: bold;'>Warning !!!</span>",
                        text: "<span style='font-size: 15px; color: #000;'>[C001] --- Please Select Project Name</span>",
                        type: "warning",
                        timer: 2500,
                        showConfirmButton: false,
                        allowOutsideClick: false
                    ...
                    //hide
                    setTimeout(function() {
                        document.form.sel_fj_name.focus();
                    }, 2500);
                    ...
                    $.ajax({
                        type: 'POST',
                        async: false,
                        url: '<?= $CFG->src_location_check; ?>/tag_code_des_terminal.php',
                        data: {
                            tag_code: $("#txt_tag_id").val(),
                            project_name: $('#sel_fj_name').val(),
        ...
        //                         type: 'POST',
        //                         async: false,
        //                         url: '<?= $CFG->src_location_check; ?>/insert_checking_stock_list_terminal.php',
        //                         data: {
        //                             palate_code: stock_pallet_code,
        //                             tags_code: stock_tags_code,
        //                             fg_code: stock_tags_fg_code_gdj,
