...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-caret-right"></i>&nbsp;Usage Confirm (Retrun)<small>สแกน Tags เพื่อคืนเข้า stock</small></h1>
      <ol class="breadcrumb">
        <li><a href="<?=$CFG->wwwroot;?>/home"><i class="fa fa-home"></i>Home</a></li><li class="active">Usage Confirm (Retrun)</li>
      </ol>
    </section>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box box-warning">
					<div class="box-header with-border">
					  <h3 class="box-title"><i class="glyphicon glyphicon-qrcode"></i> Return Tags <small><font style="color: red; font-size:12px;">*ลูกค้าคืนสินค้าในส่วนนี้</font></small></h3>
					</div>
					
					<div class="box-header with-border">
						<div class="col-md-4"><img src="<?=$CFG->iconsdir;?>/Ecommerce-Barcode-Scanner-icon.png" height="16px"> Scan Tags:
						<input type="text" id="txt_return_scan_tags" name="txt_return_scan_tags" onKeyPress="if (event.keyCode==13){ return _onScan_TagsID(); }" class="form-control input-lg" placeholder="Scan Tags ID." autocomplete="off" autocorrect="off"  spellcheck="false"></div>
					</div>
