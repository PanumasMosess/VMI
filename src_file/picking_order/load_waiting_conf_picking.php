...
<div class="box-body table-responsive padding">
  <table id="tbl_picking_order" class="table table-bordered table-hover table-striped nowrap">
	...
	<tr style="font-size: 13px;">
	  ...
	  <th style="text-align: center;"><input type="checkbox" class="largerRadio" onClick="toggle_chk_picking(this)" data-placement="top" data-toggle="tooltip" data-original-title="Select all"/></th>
