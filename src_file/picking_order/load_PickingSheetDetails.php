...
<div class="box-body table-responsive padding">
  <table id="PickingSheetDetails" class="table table-bordered table-hover table-striped nowrap">
	<thead>
...
?>
	<tr style="font-size: 13px;">
	  <td><?=$row_id_PickingSheetDetails;?></td>
...
<!--alert no item-->
<input type="hidden" name="hdn_row_PickingSheetDetails" id="hdn_row_PickingSheetDetails" value="<?=$row_id_PickingSheetDetails;?>" />
