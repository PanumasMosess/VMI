...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		var buttons = new $.fn.dataTable.Buttons(replnishmentTable, {
            buttons: [{
                extend: 'excel',
                text: '<i class="fa fa-file-excel-o"></i> Export Replenishment',
                titleAttr: 'Excel Replenishment Report',
                title: 'Excel Replenishment Report',
                exportOptions: {
                    modifier: {
                        page: 'all'
                    },
