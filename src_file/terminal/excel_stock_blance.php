...
$objPHPExcel->getActiveSheet()->setCellValue('A1', "Report Stock Blance On $buffer_datetime");
...
header('Content-Disposition: attachment;filename="Report Stock Blance ('.$buffer_datetime.').xls"');
