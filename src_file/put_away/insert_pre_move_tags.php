...
/**********************************************************************************/
/*var *****************************************************************************/
$iden_txt_move_scn_tag_id = isset($_POST['iden_txt_move_scn_tag_id']) ? $_POST['iden_txt_move_scn_tag_id'] : '';
...
and
receive_tags_code = '$iden_txt_move_scn_tag_id'
";
...
if($result_match)//check match
{
	...
	$strSQL_dup_pre_move_tags = "select tags_move_tags_code from tbl_internal_move_tags 
	where 
	tags_move_tags_code = '$iden_txt_move_scn_tag_id'
	";
	...
	{
		//insert tags
		$strSql_insert_tags = " INSERT INTO [dbo].[tbl_internal_move_tags]
           (
			[tags_move_tags_code]
			,[tags_move_by]
			,[tags_move_date]
