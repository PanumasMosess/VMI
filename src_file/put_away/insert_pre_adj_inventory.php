...
/**********************************************************************************/
/*var *****************************************************************************/
$iden_txt_move_scn_tag_id_adjustStock = isset($_POST['iden_txt_move_scn_tag_id_adjustStock']) ? $_POST['iden_txt_move_scn_tag_id_adjustStock'] : '';
...
and
receive_tags_code = '$iden_txt_move_scn_tag_id_adjustStock'
";
...
if($result_match)//check match
{
	...
	where 
	tags_tags_code = '$iden_txt_move_scn_tag_id_adjustStock'
	";
	...
	else
	{
		...
		VALUES
		   (
		   '$iden_txt_move_scn_tag_id_adjustStock'
...
else 
{
	...
	where 
	tags_code = '$iden_txt_move_scn_tag_id_adjustStock'
	";
