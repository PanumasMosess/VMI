...
<div class="box-header with-border">
	<div class="col-md-6"><i class="fa fa-qrcode"></i> Scan Pallet ID.: <input type="text" id="txt_move_scn_pallet_id_adjustStock" name="txt_move_scn_pallet_id_adjustStock" onKeyPress="if (event.keyCode==13){ return _onScan_PalletID_adjustStock(); }" class="form-control input-sm" placeholder="Scan Tags ID." autocomplete="off" autocorrect="off"  spellcheck="false"></div>
</div>
<div class="box-body table-responsive padding">
  <table id="tbl_adj_stock" class="table table-bordered table-hover table-striped nowrap">
	<thead>
	<tr style="font-size: 18px;">
		<th colspan="9" class="bg-maroon"><b><font style="color: #FFF;"><i class="fa fa-compress fa-lg"></i> Delete Tags / Delete Stock (* Status = Received only)(By Pallet)</font></b><span style="float: right;"><button type="button" class="btn btn-default btn-sm" onclick="_confirm_adjust_stock_pallet();"><i class="fa fa-check-circle-o fa-lg"></i> Confirm Adjust Inventory</button>&nbsp;<button type="button" class="btn btn-default btn-sm" onclick="_remove_adjust_stock_pallet()"><i class="fa fa-trash fa-lg"></i> Clear</button></span></th>
	</tr>
...
$(document).ready(function()
{
	...
	//toUpperCase
	$('#txt_move_scn_pallet_id_adjustStock').keyup(function() { this.value = this.value.toUpperCase(); });
