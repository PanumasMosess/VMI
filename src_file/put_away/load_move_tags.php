...
<div class="box-header with-border">
	...
	<div class="col-md-6"><i class="fa fa-qrcode"></i> Scan Pallet ID. (Destination): <font style="color: red; font-size:12px;">* สแกน Pallet ID ที่จะย้ายไป</font><input type="text" id="txt_move_scn_new_pallet" name="txt_move_scn_new_pallet" onKeyPress="if (event.keyCode==13){ return _onScan_TagsID_newPallet(); }" class="form-control input-sm" placeholder="Scan Pallet ID. (Destination)" autocomplete="off" autocorrect="off"  spellcheck="false"></div>
</div>
<div class="box-body table-responsive padding">
  <table id="tbl_move_tags" class="table table-bordered table-hover table-striped nowrap">
	<thead>
	<tr style="font-size: 18px;">
		<th colspan="9" class="bg-yellow"><b><font style="color: #FFF;"><i class="fa fa-arrows"></i> Move Tags </font><font style="color: #FFF; font-size:12px">(ย้าย Tags ID ไปยัง Pallet อื่นๆ สามารถย้ายได้ครั้งละหลาย Tags )</font></b><span style="float: right;"><button type="button" class="btn btn-default btn-sm" onclick="_remove_pre_move_tags()"><i class="fa fa-trash fa-lg"></i> Clear</button></span></th>
	</tr>
