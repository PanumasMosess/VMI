...
//check customer
if ($txt_sel_cus == "ALBATROSS LOGISTICS CO., LTD.") {
	// //Check file upload
	if ($fileupload) {
...
} else if ($txt_sel_cus == "MITSUBISHI ELECTRIC THAI AUTO-PART") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "THAI TECHNO PLATE CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "SUZUYO DISTRIBUTION CENTER (THAILAND) LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "MAZDA SALES (THAILAND) CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "MAZDA LOGISTICS AND YUSEN (ASIA) CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "NISSAN SPRING (THAILAND) CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "LOGISTICS ALLIANCE (THAILAND) CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "NISSAN TRADING (THAILAND) CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "SUPERB FURNITURE (THAILAND) CO., LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "TAISEI PLAS (THAILAND) CO., LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "T.A.P STANDARD CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "SPEED QUEEN LAUNDRY (THAILAND) CO., LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "CHUSEI (THAILAND) CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "P.S INNOVATION PART CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "LINAK APAC LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "GENTOS (THAILAND) C0.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "KYB STEERING (THAILAND) CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "TAYIH KENMOS AUTO PARTS (THAILAND) CO., LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "SUMIRIKO EASTERN RUBBER (THAILAND) LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "XCELLENT MANUFACTURING") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "E-COMMERCE") {
	// //Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "EXCELLENT INDUSTRIES CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "ALLIANCE LAUNDRY (THAILAND) CO., LTD. ") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "ENRICH INDUSTRIAL (THAI) CO., LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "NHK ANTOLIN (THAILAND) CO.,LTD.") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "YITING PACKAGING MATERIAL (THAILAND) CO., LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
...
} else if ($txt_sel_cus == "HONG YIP MOULD CO.,LTD") {
	//Check file upload
	if ($fileupload) {
		$array_last = explode(".", $fileupload_name);
		$c = count($array_last) - 1;
