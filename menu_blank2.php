...
<aside class="main-sidebar">
	...
	<section class="sidebar">
	  ...
	  <ul class="sidebar-menu" data-widget="tree">
		<li class="header"><i class="fa fa-list-ul"></i> MAIN NAVIGATION</li><span id="load_client"></span>
		<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "home2" ){ echo "active"; } ?>">
		  <a href="<?=$CFG->wwwroot;?>/home2">
			<i class="fa fa-dashboard"></i> <span>Dashboard</span>
		  </a>
		</li>
		<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "home_bill_link" ){ echo "active"; } ?>">
		<a href="<?=$CFG->wwwroot;?>/home_bill_link">
			<i class="fa fa-dashboard"></i> <span>Dashboard Billing</span>
		  </a>
		</li>					
	  </ul>
	</section>
