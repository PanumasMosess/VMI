...
//check condition tag is null
if($tag == "")
{
	$sql_condition = " tags_token = '$token' ";
}
else
{
	$sql_condition = " tags_code = '$tag' ";
}
...
while($rs = sqlsrv_fetch_array($qr, SQLSRV_FETCH_ASSOC))
{
	...
	$html .= '<tr><td width="49%"><table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				<td colspan="3" style="border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>FG Code GDJ:</font> <br><font style="font-size: 8pt";>&nbsp;<b>'.$rs['tags_fg_code_gdj'].'</b></font> <barcode code="'.$rs['tags_fg_code_gdj'].'" type="C39" class="barcode" size="0.8" height="0.9"/></td>
			  </tr>
			  <tr>
