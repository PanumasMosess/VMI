...
/**********************************************************************************/
/*var *****************************************************************************/
$picking_sheet_no = isset($_REQUEST['picking_sheet_no']) ? $_REQUEST['picking_sheet_no'] : '';

//decode
$tag = var_decode($picking_sheet_no);
...
on tbl_tags_running.tags_code = tbl_picking_tail.ps_t_tags_code
 where tbl_picking_tail.ps_t_picking_code = '$tag'
 group by
 [tags_code]
      ,[tags_fg_code_gdj]
      ,[tags_fg_code_gdj_desc]
...
while($rs = sqlsrv_fetch_array($qr, SQLSRV_FETCH_ASSOC))
{
	...
	$html .= '<tr><td width="49%"><table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				<td colspan="4" style="border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>Description:</font> <br>&nbsp;<font style="font-size: 13pt;font-family: thsarabun;"><b>'.$rs['tags_fg_code_gdj_desc'].'</b></font></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			  	<td colspan="4" style="text-align: left; border-top:solid 1px #fff; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 10pt;">PO Customer:</font><font style="font-size: 11pt;">&nbsp;<b>'.$rs['ps_t_ref_replenish_code'].'</b></font></td>
			  </tr>
	...
	$html .= '<td width="49%"><table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			 	 <td colspan="4" style="text-align: left; border-top:solid 1px #fff; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font font-size: 10pt;>PO Customer:</font><font style="font-size: 11pt;">&nbsp;<b>'.$rs['ps_t_ref_replenish_code'].'</b></font></td>
			  </tr>
			</table></td><td width="2%"></td>';
	}
	if($i%$numCol==0){
	$html .= '<td width="49%"><table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			  	<td colspan="4" style="border-top:solid 1px #fff; text-align: left; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 10pt;">PO Customer:</font><font style="font-size: 11pt;">&nbsp;<b>'.$rs['ps_t_ref_replenish_code'].'</b></font></td>
			  </tr>
			</table></td></tr>';
	}
	$i++;
