...
$q=" SELECT [tags_code]
      ...
      ,[tags_token]
	  ,[tags_issue_date]	  
FROM tbl_internal_move_project_log
left join tbl_tags_running
on tbl_internal_move_project_log.tags_log_move_pj_tags_code = tbl_tags_running.tags_code
 where tags_log_move_pj_token = '$token'
 group by
 [tags_code]
      ,[tags_fg_code_gdj]
      ,[tags_fg_code_gdj_desc]
