...
while($rs = sqlsrv_fetch_array($qr, SQLSRV_FETCH_ASSOC))
{
	...
	$html .= '<tr><td width="49%"><table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				<td colspan="3" style="border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>FG Code GDJ:</font> <br>&nbsp;<b>'.$rs['tags_fg_code_gdj'].'</b></td>
			  </tr>
			  <tr>
				<td colspan="4" style="border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>Description:</font> <br>&nbsp;<font style="font-size: 10pt;"><b>'.$rs['tags_fg_code_gdj_desc'].'</b></font></td>
			  </tr>
			  <tr>
				<td colspan="2" style="border-bottom:solid 1px #000; border-left:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>Customer Code:</font> <br>&nbsp;<b>'.$str_cus_code.'</b></td>
				<td colspan="2" style="border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>Quantity:</font> <br>&nbsp;<b>'.$rs['tags_packing_std'].'</b></td>
			  </tr>
			  <tr>
				<td colspan="3" style="border-bottom:solid 1px #000; border-left:solid 1px #000;">&nbsp;<font style="font-size: 8pt";>Tag ID:</font> <br>&nbsp;<b>'.$rs['tags_code'].'</b></td>
			  ...
			  <tr>
				<td colspan="3" style="text-align: center; border-bottom:solid 1px #000; border-left:solid 1px #000;" class="barcodecell"><barcode code="'.$rs['tags_code'].'" type="C39" class="barcode" size="0.8" height="0.9"/></td>
			  </tr>
