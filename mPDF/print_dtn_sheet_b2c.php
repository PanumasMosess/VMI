...
while($objResult_DTNHead = sqlsrv_fetch_array($objQuery_DTNHead, SQLSRV_FETCH_ASSOC))
{
	...
	$b2c_track_num = $objResult_DTNHead['b2c_track_num'];
	$b2c_delivery_address = $objResult_DTNHead['b2c_delivery_address'];
	$b2c_cus_zipcode = $objResult_DTNHead['b2c_cus_zipcode'];
	$b2c_customer_name = $objResult_DTNHead['b2c_customer_name'];
	$b2c_tel = $objResult_DTNHead['b2c_tel'];
	$b2c_tax_inv = $objResult_DTNHead['b2c_tax_inv'];
...
<tr>
  ...
  <td colspan="5" align="center"><font style="font-size: 15pt;"><b>Delivery Transfer Note</b></font><br><barcode code="'.$dn_h_dtn_code.'" type="C39" class="barcode" size="0.8" height="1.5"/><br>'.$dn_h_dtn_code.'</td>	  
  <td colspan="2" align="right">
  <barcode code="'.$dn_h_dtn_code.'" class="qrCode" type="QR" size="0.6" error="M" disableborder = "1"/></td>
</tr>
<tr>
  <td colspan="9" style="font-size: 15pt;font-family: thsarabun; border-top:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<b>Customer:</b> '.$b2c_customer_name.'&nbsp;&nbsp;&nbsp;<b>Tracking Number:</b> '.$b2c_track_num.'&nbsp;&nbsp;&nbsp;<b>Tel:</b> '.$b2c_tel.'&nbsp;&nbsp;&nbsp;<b>Tax Invoice:</b> '.$b2c_tax_inv.'<br>&nbsp;<b>Address:</b> '.$b2c_delivery_address.'&nbsp;'.$b2c_cus_zipcode.'</td>	  
</tr>
<tr>
  <td colspan="9" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 10pt; border-top:solid 1px #000; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">
	<tr>
...
<tr>
  ...
  <td rowspan="2" width="13%" style="font-size: 9pt; text-align: center; border-top:solid 1px #000; border-right:solid 1px #000; border-left:solid 1px #000; background-color: #D3D3D3;"><b>Price (Bath)</b></td>
...
while($objResult_DTNSheetDetails = sqlsrv_fetch_array($objQuery_DTNSheetDetails, SQLSRV_FETCH_ASSOC))
{
    ...
    $b2c_sale_including_vat = $objResult_DTNSheetDetails['b2c_sale_including_vat'];

	$bom_fg_desc = substr($bom_fg_desc, 0, 26);

	$b2c_sale_including_vat = $b2c_sale_including_vat / $num_row_DTNSheetDetails;
...
<tr>
  <td colspan="9" style="font-size: 10pt; border-top:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">&nbsp;<b>Customer:</b> '.$dn_h_cus_name.'<br>&nbsp;<b>Address:</b> '.$dn_h_cus_address.'</td>	  
</tr>
<tr>
  <td colspan="9" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 10pt; border-top:solid 1px #000; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">
	<tr>
...
<tr>
  <td colspan="9" style="font-size: 5pt;">&nbsp;</td>	  
	...
	$html .= '<tr>
      ...
      <td rowspan="2" style="font-size: 8pt; text-align: center; '.$str_css_bottom.' border-left:solid 1px #000; border-right:solid 1px #000; border-top:solid 1px #000;">'.$b2c_sale_including_vat.'</td>
	  <td rowspan="2" style="font-size: 8pt; text-align: center; '.$str_css_bottom.' border-right:solid 1px #000; border-top:solid 1px #000;"></td>
	</tr>
	<tr>
	...
	<tr>
  		<td colspan="9" style="font-size: 0.5pt;">&nbsp;</td>	  
	</tr>
	';
}
	$html .= '
	...
	<tr>
	  <td colspan="9" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 10pt; border-top:solid 1px #000; border-bottom:solid 1px #000; border-left:solid 1px #000; border-right:solid 1px #000;">
		<tr>
		  <td width="50%" style="border-right:solid 1px #000;">
...
if($b2c_tax_inv != '-'){
	...
	<font style="font-size: 16pt; font-family: thsarabun;font-weight:bold; color:red;"><b>*ขอใบกำกับภาษีฉบับเต็ม</b></font>
	</body>
	</html>
	';
}else{
