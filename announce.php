  ...
  <div class="box box-solid">
	...
	<div class="box-body">
		...
		<div class="box-header no-border">
			<p><img src="<?=$CFG->logodir;?>/dscm final white.jpg" style="height:115px; border: 1.5px solid #ddd; border-radius: 4px;padding: 5px;"/>&nbsp;<img src="<?=$CFG->logodir;?>/GDJ3.jpg" style="height:115px; border: 1.5px solid #ddd; border-radius: 4px;padding: 5px;"/></p>
