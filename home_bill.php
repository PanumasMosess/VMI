            ...
            <section class="content">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <i class="fa fa-bar-chart"> </i><b>WMS - Monitoring Summary Weekly</b><span id="load_client_price"></span>
                                <!-- <div class="pull-right">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <i class="fa fa-bar-chart"> </i><b>WMS - Monitoring Summary Monthly</b><span id="load_client_price"></span>
                                <!-- <div class="pull-right">
                                <select class="form-control" name="txt_sel_pro_board" id="txt_sel_pro_board" style="width: 100%; background-color:#f4f4f4">
                                    <option selected="selected" value="">All Project</option>
                        ...
                        <button type="button" class="btn btn-default" style="font-size:10px;" id="daterange-btn-last-5">
                            <span>
