...
<aside class="main-sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' ) == "print_tags" || basename($_SERVER["SCRIPT_FILENAME"], '.php' ) == "tags_history" || basename($_SERVER["SCRIPT_FILENAME"], '.php' ) == "put_away" || basename($_SERVER["SCRIPT_FILENAME"], '.php' ) == "wms_tools" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="replenishment" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="picking" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="picking_QC" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_cover_sheet" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="dtn_order" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_do" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "replenishment_b2c" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "picking_b2c" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "dtn_order_b2c" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_on_hand" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_move_pj_fg" 
				...
				<ul class="treeview-menu">
					...
					<li class="treeview  <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_on_hand" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_move_pj_fg" 
					
					
					){ echo "active"; } ?>">
		  				<a href="#">
							<i class="fa fa-cubes"></i><span>WMS Stock</span>
							<i class="fa fa-angle-left pull-right"></i>
		  				</a>
						<ul class="treeview-menu">
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_on_hand"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/wms_stock_on_hand"><i class="fa fa-pie-chart"></i><span>Fulfillment Center</span></a></li>
							<!--<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "xxxxxx"){ echo "active"; } ?>"><a href="#"><i class="fa fa-plus"></i><span>Put-Away Tags</span></a></li>
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "xxxxxx"){ echo "active"; } ?>"><a href="#"><i class="fa fa-arrows"></i><span>Move Pallet</span></a></li>
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "xxxxxx"){ echo "active"; } ?>"><a href="#"><i class="fa fa-arrows"></i><span>Move Tags</span></a></li>
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "xxxxxx"){ echo "active"; } ?>"><a href="#"><i class="fa fa-arrows"></i><span>Move Project (Tags)</span></a></li>-->
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "wms_stock_move_pj_fg"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/wms_stock_move_pj_fg"><i class="fa fa-arrows"></i><span>Move Project (FG Code)</span></a></li>
							<!--<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "xxxxxx"){ echo "active"; } ?>"><a href="#"><i class="fa fa-compress"></i><span>Adjust Inventory</span></a></li>-->
						</ul>	
					</li>
					...
					<li class="treeview  <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "picking" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "picking_b2c"){ echo "active"; } ?>">
		  			<a href="#">
						<i class="fa fa-file-text-o"></i><span>Picking Order</span>
						<i class="fa fa-angle-left pull-right"></i>
		  			</a>
						<ul class="treeview-menu">
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "picking"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/picking"><i class="fa fa-file-text-o"></i><span>Picking Order</span></a></li>
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "picking_b2c"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/picking_b2c"><i class="fa fa-file-text-o"></i><span>B2C Picking Order</span></a></li>
						</ul>	
					</li>
					...
					<li class="treeview  <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "dtn_order" || basename($_SERVER["SCRIPT_FILENAME"], '.php') == "dtn_order_b2c"){ echo "active"; } ?>">
		  				<a href="#">
							<i class="fa fa-check-square-o"></i><span>Confirm DTN</span>
							<i class="fa fa-angle-left pull-right"></i>
		  				</a>
						<ul class="treeview-menu">
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "dtn_order"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/dtn_order"><i class="fa fa-check-square-o"></i><span>Confirm DTN</span></a></li>
							<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php') == "dtn_order_b2c"){ echo "active"; } ?>"><a href="<?=$CFG->wwwroot;?>/dtn_order_b2c"><i class="fa fa-check-square-o"></i><span>B2C Confirm DTN</span></a></li>
						</ul>	
					</li>
				</ul>
			</li>
			...
			<li class="treeview <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="bom_recheck" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="replenishment_reject" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="billing" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="picking_history" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="dtn_history" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="tag_check" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="put_away_history" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="billing_tag" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_history" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="b2c_status" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="sale_order_abb" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_lot" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_by_date" ) { echo "active" ; } ?>">
				<a href="#">
					<i class="fa fa-search"></i> <span>Reporting</span>
					<i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="bom_recheck" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/bom_recheck"><i class="fa fa-file-text-o"></i> <span>Bom Recheck</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="replenishment_reject" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/replenishment_reject"><i class="fa fa-file-text-o"></i> <span>Replenishment Reject</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="billing" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/billing"><i class="fa fa-file-text-o"></i> <span>Billing</span></a></li>
					<?
					if($objResult_authorized['user_section'] == "IT")
					{ //IT ALL 
					?>
						<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="billing_tag" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/billing_tag"><i class="fa fa-file-text-o"></i> <span>Billing By Tag</span></a></li>
					<?			
					}
					?>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_by_date" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/print_tag_by_date"><i class="fa fa-file-text-o"></i> <span>Print Tag By Date</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_history" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/print_tag_history"><i class="fa fa-file-text-o"></i> <span>Print Tag Today History</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="print_tag_lot" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/print_tag_lot"><i class="fa fa-file-text-o"></i> <span>Print Tag lot Today History</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="put_away_history" ){ echo "active" ; }; ?>"><a href="<?= $CFG->wwwroot; ?>/put_away_history"><i class="fa fa-file-text-o"></i> <span>Put Away(Receive) History</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="picking_history" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/picking_history"><i class="fa fa-file-text-o"></i> <span>Picking History</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="dtn_history" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/dtn_history"><i class="fa fa-file-text-o"></i> <span>DTN History</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="b2c_status" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/b2c_status"><i class="fa fa-file-text-o"></i> <span>DTN B2C Status</span></a></li>
					<li class="<? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="tag_check" ){ echo "active" ; } ?>"><a href="<?= $CFG->wwwroot; ?>/tag_check"><i class="fa fa-file-text-o"></i> <span>Tag Terminal Checking</span></a></li>
					...
					<!-- <li><a href="<?= $CFG->wwwroot; ?>/xxxxx"><i class="fa fa-file-text-o"></i> <span>Invoice</span></a></li> -->
				</ul>
			</li>
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
		  ...
		  <ul class="treeview-menu">
			...
			<li class="treeview <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="bom_recheck" || basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="billing" ){ echo "active" ; } ?>">
				<a href="#">
					<i class="fa fa-search"></i> <span>Reporting</span>
					<i class="fa fa-angle-left pull-right"></i>
				</a>
	...
	else if($objResult_authorized['user_type'] == "Account")
	{
	?>
		<!-- sidebar: style can be found in sidebar.less -->
		<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <? if(basename($_SERVER["SCRIPT_FILENAME"], '.php' )=="sale_order_history" ||  basename($_SERVER["SCRIPT_FILENAME"], '.php' ) == "sale_order_abb" ){ echo "active" ; } ?>">
				<a href="#">
					<i class="fa fa-search"></i> <span>Reporting</span>
					<i class="fa fa-angle-left pull-right"></i>
				</a>
...
<div class="modal fade" id="modal-waiting-success" style="z-index: 1111;" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<p>
					<center><span id="al_results_waiting_success"></span><br><img src="<?= $CFG->imagedir; ?>/ajax-loader3.gif" border="0" width="120px"></center>
				</p>
			</div>
		</div>
		<!-- /.modal-content -->
