...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-caret-right"></i>&nbsp;Picking Order<small>FIFO Picking</small></h1>
      <ol class="breadcrumb">
        <li><a href="<?=$CFG->wwwroot;?>/home"><i class="fa fa-home"></i>Home</a></li><li class="active">Picking Order</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <!-- /.box -->
		...
		<div class="box box-warning">
			<div class="box-header with-border">
			  <h3 class="box-title"><i class="fa fa-check-square-o"></i> Confirm Picking Sheet</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
			  ...
			  <!-- /.row -->
				...
				<div class="box-header with-border">
				  <h3 class="box-title"><i class="fa fa-cart-plus"></i> Confirmed Replenishment Order List</h3> | <font style="color: #F00;">* Please select by Project or Customer</font>
				</div>
				<!-- /.box-header -->
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-header with-border">
					  <h3 class="box-title"><i class="fa fa-files-o"></i> Picking Sheet List (Waiting Picking QC)</h3>
					</div>
					<!-- /.box-header -->
...
function _load_openFuncPickingSheetDetails(id)
{
	...
	setTimeout(function(){
		...
		$("#spn_load_picking_details").load("<?=$CFG->src_picking_order;?>/load_PickingSheetDetails.php", { t_ps_h_picking_code: t_ps_h_picking_code, t_ps_h_cus_code: t_ps_h_cus_code, t_ps_h_cus_name: t_ps_h_cus_name, t_ps_t_pj_name: t_ps_t_pj_name, t_ps_h_status: t_ps_h_status, t_ps_h_issue_date: t_ps_h_issue_date });
	},300);
}
...
function _load_picking_sheet_details()
{
	...
	setTimeout(function(){
		...
		$("#spn_load_picking_sheet_details").load("<?=$CFG->src_picking_order;?>/load_picking_sheet_details.php");
	},300);
}
...
function _load_hdn_encode_curr_picking_no()
{
	...
	setTimeout(function(){
		...
		$("#spn_load_encode_curr_picking_no").load("<?=$CFG->src_picking_order;?>/get_encode_picking.php", { curr_picking_no: $("#txt_curr_picking_no").val() });
	},300);
}
...
function _load_picking_details(id)
{
	...
	setTimeout(function(){
		//$("#spn_load_picking_details").html(""); //clear span
		$("#spn_load_picking_details").load("<?=$CFG->src_picking_order;?>/load_picking_order_details.php", { t_fg_code_set_abt: t_fg_code_set_abt, t_sku_code_abt: t_sku_code_abt, t_fg_code_gdj: t_fg_code_gdj, t_pj_name: t_pj_name, t_ship_type: t_ship_type, t_part_customer: t_part_customer, t_conv_pack_qty: t_conv_pack_qty, t_repn_id: t_repn_id });
	},300);
}
...
function _load_SplitTags(id)
{
	...
	setTimeout(function(){
		...
		$("#spn_load_splitTags").load("<?=$CFG->src_picking_order;?>/load_picking_SplitTags.php", { t_fg_code_set_abt: t_fg_code_set_abt, t_sku_code_abt: t_sku_code_abt, t_fg_code_gdj: t_fg_code_gdj, t_pj_name: t_pj_name, t_ship_type: t_ship_type, t_part_customer: t_part_customer, t_conv_pack_qty: t_conv_pack_qty, t_repn_qty: t_repn_qty, t_repn_id: t_repn_id });
	},300);
}
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title"><i class="fa fa-search"></i> Picking Order Details</h4>
	  </div>
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		  <span aria-hidden="true">&times;</span></button>
		<h4 class="modal-title"><i class="fa fa-search"></i> Picking Order Details (Split Tags)</h4>
	  </div>
	  <div class="modal-body">
		<div class="box-body table-responsive padding">
